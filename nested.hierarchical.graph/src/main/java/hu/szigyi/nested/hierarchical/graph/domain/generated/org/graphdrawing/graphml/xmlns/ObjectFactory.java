...
public class ObjectFactory {
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link DefaultType }
	 * {@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "http://graphml.graphdrawing.org/xmlns", name = "default")
	public JAXBElement<DefaultType> createDefault(final DefaultType value) {
	...
	public JAXBElement<EdgeType> createEdge(final EdgeType value) {
		return new JAXBElement<EdgeType>(_Edge_QNAME, EdgeType.class, null, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link EndpointType }
	 * {@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "http://graphml.graphdrawing.org/xmlns", name = "endpoint")
	public JAXBElement<EndpointType> createEndpoint(final EndpointType value) {
	...
	public JAXBElement<NodeType> createNode(final NodeType value) {
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link PortType }
	 * {@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "http://graphml.graphdrawing.org/xmlns", name = "port")
	public JAXBElement<PortType> createPort(final PortType value) {
		return new JAXBElement<PortType>(_Port_QNAME, PortType.class, null, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link GraphmlType }
	 * {@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "http://graphml.graphdrawing.org/xmlns", name = "graphml")
	public JAXBElement<GraphmlType> createGraphml(final GraphmlType value) {
	...
	public JAXBElement<KeyType> createKey(final KeyType value) {
		return new JAXBElement<KeyType>(_Key_QNAME, KeyType.class, null, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link GraphType }
	 * {@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "http://graphml.graphdrawing.org/xmlns", name = "graph")
	public JAXBElement<GraphType> createGraph(final GraphType value) {
	...
	public JAXBElement<String> createDesc(final String value) {
	...
	public JAXBElement<LocatorType> createLocator(final LocatorType value) {
		return new JAXBElement<LocatorType>(_Locator_QNAME, LocatorType.class, null, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link HyperedgeType }
	 * {@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "http://graphml.graphdrawing.org/xmlns", name = "hyperedge")
	public JAXBElement<HyperedgeType> createHyperedge(final HyperedgeType value) {
